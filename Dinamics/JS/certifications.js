window.PROJECT_PAGE = {
    en: {
        ...
        cert1Institution: "Institution: Placeholder Issuer",
        ...
        cert2Institution: "Institution: Placeholder Issuer",
        ...
        cert3Institution: "Institution: Placeholder Issuer",
    ...
    es: {
        ...
        cert1Institution: "Institución: Emisor placeholder",
        ...
        cert2Institution: "Institución: Emisor placeholder",
        ...
        cert3Institution: "Institución: Emisor placeholder",
...
window.afterProjectLanguageSet = (lang) => {
    ...
    if (cert1Institution) cert1Institution.textContent = copy.cert1Institution;
    ...
    if (cert2Institution) cert2Institution.textContent = copy.cert2Institution;
    ...
    if (cert3Institution) cert3Institution.textContent = copy.cert3Institution;
